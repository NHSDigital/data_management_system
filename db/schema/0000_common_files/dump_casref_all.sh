...
case $ETYPE in
    ...
    PSMOLE)
        ...
        FIELDS_molecular_data=molecular_data.molecular_dataid,molecular_data.ppatient_id,molecular_data.providercode,molecular_data.practitionercode,molecular_data.patienttype,molecular_data.requesteddate,molecular_data.collecteddate,molecular_data.receiveddate,molecular_data.authoriseddate,molecular_data.indicationcategory,molecular_data.clinicalindication,molecular_data.moleculartestingtype,molecular_data.organisationcode_testresult,molecular_data.servicereportidentifier,molecular_data.specimentype,molecular_data.otherspecimentype,molecular_data.tumourpercentage,molecular_data.specimenprep,molecular_data.karyotypingmethod,molecular_data.genetictestscope,molecular_data.isresearchtest,molecular_data.genetictestresults,molecular_data.sourcetype,molecular_data.comments,molecular_data.datefirstnotified,molecular_data.raw_record,molecular_data.age
...
FIELDS_ppatients=ppatients.id,ppatients.e_batch_id,ppatients.ppatient_rawdata_id,ppatients.type,ppatients.pseudo_id1,ppatients.pseudo_id2,ppatients.pseudonymisation_keyid
FIELDS_ppatients_short="ppatients.id,ppatients.e_batch_id,ppatients.ppatient_rawdata_id,ppatients.type,
