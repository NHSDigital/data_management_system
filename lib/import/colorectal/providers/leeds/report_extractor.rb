...
module Leeds
  ...
  class DoubleNormalMLPAFail < GenotypePattern
    include Utility
    VALID_REGEX = /^normal #{BRCA} and #{BRCA}, MLPA fail$/i
    SEQUENCE    = /screened for #{BRCA} and #{BRCA} mutations by sequence analysis/i
    MLPA        = /mlpa analysis of #{BRCA} failed/i
