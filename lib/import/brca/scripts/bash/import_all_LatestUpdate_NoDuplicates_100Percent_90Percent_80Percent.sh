...
PROV='RVJ'
IFS=$'\n'
for x in $(find  $MBIS/private/pseudonymised_data/updated_files/ -type f -name "*.pseudo" -path "*/$PROV/*"  \
-not -path "*/2017-05-09/*"    \
-not -path "*/2017-06-15/*"  )
do
IFS="$OIFS"
